...
const Pagination = ({pages , setCurrentPage , currentEmployees , sortEmployees}) => {
    ...
    return (
        <div className="clearfix">
            <div className="hint-text">Showing <b>{currentEmployees.length}</b> out of <b>{sortEmployees.length}</b> entries</div>
